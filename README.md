...
2. No Supabase, abra **SQL Editor**, cole e execute `backend/supabase/migrations/20260720000000_create_clients.sql`. O RLS limita cada barbeiro aos próprios clientes.
...
4. Instale dependências com `cd frontend; npm install` e execute `cd frontend; npm run dev`.
