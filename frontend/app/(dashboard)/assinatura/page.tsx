...
export default function AssinaturaPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      else { setMessage('Teste gratis ativado por 7 dias. A primeira cobranca sera feita ao final do periodo.'); window.setTimeout(() => { window.location.href = '/dashboard' }, 900) }
