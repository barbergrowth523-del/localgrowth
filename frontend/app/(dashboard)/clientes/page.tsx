  ...
  return (
    <div className="mx-auto w-full max-w-7xl p-8 lg:p-12">
      <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div><h1 className="flex items-center gap-3 text-3xl font-bold text-white"><Users className="h-8 w-8 text-emerald-400" /> Meus Clientes</h1><p className="mt-1 text-sm text-slate-400">Gerencie sua base de clientes e acompanhe quem precisa retornar ao salão.</p></div>
