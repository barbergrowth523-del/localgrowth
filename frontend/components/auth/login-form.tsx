...
export function LoginForm({ initialMode = 'login' }: { initialMode?: 'login' | 'signup' }) {
  ...
  return <main className="box-border flex min-h-screen w-full overflow-x-hidden bg-slate-950 pt-8 text-white lg:h-screen lg:overflow-hidden lg:pt-12">
    ...
    <section className="flex w-full lg:w-1/2 flex-col justify-center items-center px-6 sm:px-8 lg:px-12 bg-slate-950"><div className="mx-auto w-full max-w-md">
