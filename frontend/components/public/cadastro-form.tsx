...
export default function CadastroForm({ barbearia }: { barbearia: string }) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch('/api/cadastro', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ barbearia, nome, telefone, dataNascimento }) })
