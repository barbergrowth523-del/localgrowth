...
export default function PublicBookingForm({ barbearia }: { barbearia: string }) {
  ...
  </section><footer className="mx-auto mt-8 w-full max-w-screen-2xl border-t border-slate-800 pt-5"><LegalLinks className="justify-center" /></footer></main>
}
