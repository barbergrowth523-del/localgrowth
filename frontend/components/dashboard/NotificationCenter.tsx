...
export function NotificationCenter({ inline = false }: { inline?: boolean }) {
  ...
  return <div className={inline ? 'relative z-40' : 'fixed right-4 top-4 z-50 lg:right-8 lg:top-5'}>
